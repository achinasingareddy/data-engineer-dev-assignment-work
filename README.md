...
azure-medallion-university-chapters/
...
Storage: Databricks Volume
 ...
 /Volumes/dev_engineering_catalog/dev_engineering_schema/dev_engineering_volume/
...
ArcGIS University Chapters REST API
...
```
/Volumes/dev_engineering_catalog/dev_engineering_schema/dev_engineering_volume/bronze/university_chapters/<run_id>/
```
...
```
/Volumes/dev_engineering_catalog/dev_engineering_schema/dev_engineering_volume/silver/university_chapters/
```
...
Publish consumer-ready dataset.
...
chapter_id           ---    Business Key

chapter_name         ---    University Chapter
...
dq_warnings          ---    Warning Messages

published_timestamp  ---    Publish Timestamp
